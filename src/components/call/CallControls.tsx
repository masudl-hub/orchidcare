...
export function CallControls({ isMuted, isVideoActive, facingMode, onToggleMic, onToggleVideo, onToggleFacingMode, onEndCall, onCaptureSnapshot, disabled }: CallControlsProps) {
  return (
    <div style={{
      display: 'flex',
      alignItems: 'center',
      ...
      {/* Snapshot capture — only when video is active */}
      {isVideoActive && onCaptureSnapshot && (
        <button
