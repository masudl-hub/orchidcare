...
- Past problems (recurring pests, root rot history)`,
      parameters: {
        ...
        properties: {
          ...
          insight_value: { type: "string", description: "The actual insight to remember. DO NOT use single words like 'yes' or 'true'. Write a full descriptive sentence (e.g., 'The user has a cat' instead of just 'cat')." },
        },
